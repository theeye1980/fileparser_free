...
namespace FileParser
{
    public partial class MainForm : Form
    {
        ...
        public string[] description = new string[]{ "Вывести все пути или только имена файлов в csv файлик. Возможнен рекурсивный обход, либо только в выбранной папке.",
                                                ...
                                                "Разобрать стандартный YML по формату Яндекс и сохранить в csv в папку, указанную в настройках. Также можно сохранить структуру, поменять что-то в товарных предложениях и выгрузить обратно в YML",
